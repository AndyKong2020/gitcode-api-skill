...
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-merge](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-merge)
Category: Pull Requests
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/pulls/{number}/merge`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_pulls_{number}_merge`
- Tags: `Pull Requests`
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_pulls_{number}_merge",
  "parameters": [
    {
