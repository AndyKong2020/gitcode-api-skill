# Get the modification history of the Pull Request
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-modify-history](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-modify-history)
Category: Pull Requests
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/pulls/{number}/modify_history`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_pulls_{number}_modify_history`
- Tags: None
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_pulls_{number}_modify_history",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "Get the modification history of the Pull Request",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
