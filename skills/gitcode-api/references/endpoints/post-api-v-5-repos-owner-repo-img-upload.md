# Upload Image
Source: [https://docs.gitcode.com/en/docs/apis/post-api-v-5-repos-owner-repo-img-upload](https://docs.gitcode.com/en/docs/apis/post-api-v-5-repos-owner-repo-img-upload)
Category: Repositories
- Method: `POST`
- Path: `/api/v5/repos/{owner}/{repo}/img/upload`
- Operation ID: `post_api_v5_repos_{owner}_{repo}_img_upload`
- Tags: `Repositories`
- Deprecated: `false`
## Parameters
...
```json
{
  "properties": {
    "body": {
      "description": "File content in base64 format (Data URL prefix removed) (size limit: 20MB)",
      "type": "string"
    },
    "file_name": {
...
```json
{
  ...
  "method": "post",
  "operationId": "post_api_v5_repos_{owner}_{repo}_img_upload",
  "parameters": [
    {
