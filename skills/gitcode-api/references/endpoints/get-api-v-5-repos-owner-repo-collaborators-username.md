# Check if User is a Warehouse Member
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-collaborators-username](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-collaborators-username)
Category: Member
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/collaborators/{username}`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_collaborators_{username}`
- Tags: `Member`
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_collaborators_{username}",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "Check if User is a Warehouse Member",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
