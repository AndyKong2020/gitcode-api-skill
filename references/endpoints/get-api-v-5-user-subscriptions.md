# List Repositories Watched by Authorized Users
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-user-subscriptions](https://docs.gitcode.com/en/docs/apis/get-api-v-5-user-subscriptions)
Category: Users
- Method: `GET`
- Path: `/api/v5/user/subscriptions`
- Operation ID: `get_api_v5_user_subscriptions`
- Tags: `Users`
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_user_subscriptions",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "List Repositories Watched by Authorized Users",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
