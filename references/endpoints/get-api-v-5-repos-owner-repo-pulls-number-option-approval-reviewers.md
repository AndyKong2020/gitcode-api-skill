# Get the list of people who can be reviewers for a Pull Request
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-option-approval-reviewers](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-option-approval-reviewers)
Category: Pull Requests
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/pulls/{number}/option_reviewers`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_pulls_{number}_option_approval_reviewers`
- Tags: None
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_pulls_{number}_option_approval_reviewers",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "Get the list of people who can be reviewers for a Pull Request",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
