# Cancel user review Pull Request
Source: [https://docs.gitcode.com/en/docs/apis/delete-api-v-5-repos-owner-repo-pulls-number-approval-reviewers](https://docs.gitcode.com/en/docs/apis/delete-api-v-5-repos-owner-repo-pulls-number-approval-reviewers)
Category: Pull Requests
- Method: `DELETE`
- Path: `/api/v5/repos/{owner}/{repo}/pulls/{number}/reviewers`
- Operation ID: `delete_api_v5_repos_{owner}_{repo}_pulls_{number}_approval_reviewers`
- Tags: None
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "delete",
  "operationId": "delete_api_v5_repos_{owner}_{repo}_pulls_{number}_approval_reviewers",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "DELETE",
    "name": "Cancel user review Pull Request",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
