...
Source: [https://docs.gitcode.com/en/docs/apis/delete-api-v-5-repos-owner-repo-hooks-id](https://docs.gitcode.com/en/docs/apis/delete-api-v-5-repos-owner-repo-hooks-id)
Category: Webhooks
- Method: `DELETE`
- Path: `/api/v5/repos/{owner}/{repo}/hooks/{id}`
- Operation ID: `delete_api_v5_repos_{owner}_{repo}_hooks_{id}`
- Tags: `Webhooks`
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "delete",
  "operationId": "delete_api_v5_repos_{owner}_{repo}_hooks_{id}",
  "parameters": [
    {
