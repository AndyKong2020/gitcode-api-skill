...
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-user-username-starred](https://docs.gitcode.com/en/docs/apis/get-api-v-5-user-username-starred)
Category: Users
- Method: `GET`
- Path: `/api/v5/users/{username}/starred`
- Operation ID: `get_api_v5_user_{username}_starred`
- Tags: `Users`
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_user_{username}_starred",
  "parameters": [
    {
      "description": "",
      "in": "path",
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "List Repositories Starred by User",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
