# Get the list of statements from issue comments
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-issues-comment-comment-id-user-reactions](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-issues-comment-comment-id-user-reactions)
Category: Issues
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/issues/comment/{comment_id}/user_reactions`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_issues_comment_{comment_id}_user_reactions`
- Tags: None
- Deprecated: `false`
## Parameters
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_issues_comment_{comment_id}_user_reactions",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "Get the list of statements from issue comments",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
