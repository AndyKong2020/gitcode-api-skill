# Get All Issue Comments In Repository
Source: [https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-issues-comments](https://docs.gitcode.com/en/docs/apis/get-api-v-5-repos-owner-repo-issues-comments)
Category: Issues
- Method: `GET`
- Path: `/api/v5/repos/{owner}/{repo}/issues/comments`
- Operation ID: `get_api_v5_repos_{owner}_{repo}_issues_comments `
- Tags: `Issues`
- Deprecated: `false`
## Parameters
...
| sort | query | false | string | Either created or updated. Default: created |
| direction | query | false | string | Either asc or desc. Ignored without the sort parameter. |
| since | query | false | string | Only comments updated at or after this time are returned. This is a timestamp in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ |
...
```json
{
  ...
  "method": "get",
  "operationId": "get_api_v5_repos_{owner}_{repo}_issues_comments ",
  "parameters": [
    {
  ...
  "postman": {
    ...
    "method": "GET",
    "name": "Get All Issue Comments In Repository",
    "url": {
      "host": [
        "{{baseUrl}}"
      ],
      ...
      "query": [
        ...
        {
          "description": {
            "content": "Either created or updated. Default: created",
            "type": "text/plain"
          },
          "disabled": false,
          "key": "sort",
        ...
        {
          "description": {
            "content": "Either asc or desc. Ignored without the sort parameter.",
            "type": "text/plain"
          },
          "disabled": false,
          "key": "direction",
        ...
        {
          "description": {
            "content": "Only comments updated at or after this time are returned. This is a timestamp in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ",
            "type": "text/plain"
          },
          "disabled": false,
          "key": "since",
